...
CREATE OR REPLACE FUNCTION fkg.t_6100_brandhane_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6100_brandhane_t (versions_id, brandhane_id, brandhane_type_kode, modeltype, ydelse, senest_maalte_ydelse, placering_kode, lokalitet, vejkode, cvf_vejkode, husnr, postnr, funktionsstatus_kode, aktiv_kode, senest_tilsyn, link, geometri)
      SELECT
        NEW.versions_id, NEW.brandhane_id, NEW.brandhane_type_kode, NEW.modeltype, NEW.ydelse, NEW.senest_maalte_ydelse, NEW.placering_kode, NEW.lokalitet, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.funktionsstatus_kode, NEW.aktiv_kode, NEW.senest_tilsyn, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6102_redn_vej_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6102_redn_vej_t (versions_id, redvej_type_kode, redn_underomr, note, bygn_kompleks, byg_sag_nr, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.redvej_type_kode, NEW.redn_underomr, NEW.note, NEW.bygn_kompleks, NEW.byg_sag_nr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5003_draenledn_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5003_draenledn_t (versions_id, ledn_nr, ledn_type_kode, klasse_kode, noegle, anlaeg_aar, dybde, dimension, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.ledn_nr, NEW.ledn_type_kode, NEW.klasse_kode, NEW.noegle, NEW.anlaeg_aar, NEW.dybde, NEW.dimension, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5004_draenomr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5004_draenomr_t (versions_id, omr_navn, omr_type_kode, anlaeg_aar, projnr, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.omr_navn, NEW.omr_type_kode, NEW.anlaeg_aar, NEW.projnr, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5105_rig_fattig_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5105_rig_fattig_t (versions_id, stedid, natura_2000, kaer_type_kode, noegle, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.stedid, NEW.natura_2000, NEW.kaer_type_kode, NEW.noegle, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5108_groent_part_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5108_groent_part_t (versions_id, navn, kontakt_navn, kontakt_opl, deltager, formaal, gyldig_fra, gyldig_til, sagsnr, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.navn, NEW.kontakt_navn, NEW.kontakt_opl, NEW.deltager, NEW.formaal, NEW.gyldig_fra, NEW.gyldig_til, NEW.sagsnr, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5401_genbr_st_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5401_genbr_st_t (versions_id, gs_navn, gs_type_kode, p_nr, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.gs_navn, NEW.gs_type_kode, NEW.p_nr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5508_husst_moel_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5508_husst_moel_t (versions_id, moelletype, hoejde, kapacitet, stoej_kode, konsekvenszone, sagsnr, vejkode, husnr, postnr, note, geometri)
      SELECT
        NEW.versions_id, NEW.moelletype, NEW.hoejde, NEW.kapacitet, NEW.stoej_kode, NEW.konsekvenszone, NEW.sagsnr, NEW.vejkode, NEW.husnr, NEW.postnr, NEW.note, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5200_aff_prod_udbr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5200_aff_prod_udbr_t (versions_id, affald_prod_kode, navn, ejd_nr, vejkode, cvf_vejkode, husnr, postnr, markblok, dosering_toerstof, dosering_vaadvaegt, fosfor_total, fosfor_udnyttelse, kvaelstof_total, kvaelstof_udnyttelse, kalium_total, udbringning_aar, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.affald_prod_kode, NEW.navn, NEW.ejd_nr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.markblok, NEW.dosering_toerstof, NEW.dosering_vaadvaegt, NEW.fosfor_total, NEW.fosfor_udnyttelse, NEW.kvaelstof_total, NEW.kvaelstof_udnyttelse, NEW.kalium_total, NEW.udbringning_aar, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5506_spildev_pl_pkt_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5506_spildev_pl_pkt_t (versions_id, anlaeg_type_kode, planstatus_kode, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.anlaeg_type_kode, NEW.planstatus_kode, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5800_fac_pkt_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5800_fac_pkt_t (versions_id, facilitet_type_kode, belaegning_kode, handicapegnet_kode, ejerstatus_kode, navn, noegle, note, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
...
CREATE OR REPLACE FUNCTION fkg.t_5802_fac_li_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5802_fac_li_t (versions_id, facilitetl_type_kode, ejerstatus_kode, navn, straekningsnr, belaegning_kode, fremkommelighed_kode, handicapegnet_kode, startpunkt_x, startpunkt_y, afmaerket_rute_kode, noegle, note, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.facilitetl_type_kode, NEW.ejerstatus_kode, NEW.navn, NEW.straekningsnr, NEW.belaegning_kode, NEW.fremkommelighed_kode, NEW.handicapegnet_kode, NEW.startpunkt_x, NEW.startpunkt_y, NEW.afmaerket_rute_kode, NEW.noegle, NEW.note, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5902_jordv_anl_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5902_jordv_anl_t (versions_id, brine, strenge_antal, strenge_laengde_samlede, tilladelses_dato, faerdigmeldingsdato, vaesketype_kode, gyldig_fra, gyldig_til, sagsnr, sag_status_kode, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.brine, NEW.strenge_antal, NEW.strenge_laengde_samlede, NEW.tilladelses_dato, NEW.faerdigmeldingsdato, NEW.vaesketype_kode, NEW.gyldig_fra, NEW.gyldig_til, NEW.sagsnr, NEW.sag_status_kode, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5104_art_invas_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5104_art_invas_t (versions_id, invasivart_kode, noegle, inventoer, antal_kode, forekomst, sagsnr, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.invasivart_kode, NEW.noegle, NEW.inventoer, NEW.antal_kode, NEW.forekomst, NEW.sagsnr, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5107_art_invas_p_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5107_art_invas_p_t (versions_id, invasivart_kode, noegle, inventoer, antal_kode, forekomst, sagsnr, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.invasivart_kode, NEW.noegle, NEW.inventoer, NEW.antal_kode, NEW.forekomst, NEW.sagsnr, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5700_grundej_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5700_grundej_t (versions_id, forening_type_kode, forening_navn, forening_cvr, lokalpl_nr, formand, gf_tlf, gf_adresse, gf_mail, gf_adr_beskyt_kode, vedtaegt_kode, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.forening_type_kode, NEW.forening_navn, NEW.forening_cvr, NEW.lokalpl_nr, NEW.formand, NEW.gf_tlf, NEW.gf_adresse, NEW.gf_mail, NEW.gf_adr_beskyt_kode, NEW.vedtaegt_kode, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5701_lok_omr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5701_lok_omr_t (versions_id, lokalraad_navn, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.lokalraad_navn, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5702_skorst_fej_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5702_skorst_fej_t (versions_id, skorstenf_distrikt_nr, skorstenf_distrikt_navn, gyldig_fra, gyldig_til, skorstensfejer_firma, skorstensfejer_cvr, sf_tlf, sf_adresse, sf_mail, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.skorstenf_distrikt_nr, NEW.skorstenf_distrikt_navn, NEW.gyldig_fra, NEW.gyldig_til, NEW.skorstensfejer_firma, NEW.skorstensfejer_cvr, NEW.sf_tlf, NEW.sf_adresse, NEW.sf_mail, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5703_afstem_sted_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5703_afstem_sted_t (versions_id, afstemningsomraade_nr, lokalitet, opstillingskreds_nr, opstillingskreds_navn, storkreds_nr, storkreds_navn, ansvar_revision, vejkode, cvf_vejkode, husnr, postnr, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.afstemningsomraade_nr, NEW.lokalitet, NEW.opstillingskreds_nr, NEW.opstillingskreds_navn, NEW.storkreds_nr, NEW.storkreds_navn, NEW.ansvar_revision, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5705_forp_are_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5705_forp_are_t (versions_id, forpagter_navn, forpagter_formaal, udlejning_kode, landbrug_kode, note, sagsnr, gyldig_fra, gyldig_til, link, geometri)
      SELECT
        NEW.versions_id, NEW.forpagter_navn, NEW.forpagter_formaal, NEW.udlejning_kode, NEW.landbrug_kode, NEW.note, NEW.sagsnr, NEW.gyldig_fra, NEW.gyldig_til, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5707_grunds_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5707_grunds_t (versions_id, udstyk_navn, grund_type_kode, salg_status_kode, pris, mindste_pris, kvm_pris, kontakt_oplys, grundareal, bygningareal, budfrist_slut, sagsnr, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.udstyk_navn, NEW.grund_type_kode, NEW.salg_status_kode, NEW.pris, NEW.mindste_pris, NEW.kvm_pris, NEW.kontakt_oplys, NEW.grundareal, NEW.bygningareal, NEW.budfrist_slut, NEW.sagsnr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5710_born_skole_dis_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5710_born_skole_dis_t (versions_id, udd_distrikt_nr, udd_distrikt_navn, udd_distrikt_type_kode, starttrin_kode, sluttrin_kode, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.udd_distrikt_nr, NEW.udd_distrikt_navn, NEW.udd_distrikt_type_kode, NEW.starttrin_kode, NEW.sluttrin_kode, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5711_and_dis_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5711_and_dis_t (versions_id, an_distrikt_nr, an_distrikt_navn, an_distrikt_type_kode, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.an_distrikt_nr, NEW.an_distrikt_navn, NEW.an_distrikt_type_kode, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5712_plej_aeldr_dis_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5712_plej_aeldr_dis_t (versions_id, plej_distrikt_nr, plej_distrikt_navn, plej_distrikt_type_kode, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.plej_distrikt_nr, NEW.plej_distrikt_navn, NEW.plej_distrikt_type_kode, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5713_prog_stat_dis_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5713_prog_stat_dis_t (versions_id, prog_distrikt_nr, prog_distrikt_navn, prog_distrikt_type_kode, noegle, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.prog_distrikt_nr, NEW.prog_distrikt_navn, NEW.prog_distrikt_type_kode, NEW.noegle, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5714_laering_udd_inst_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5714_laering_udd_inst_t (versions_id, udd_institution_type_kode, ejerstatus_kode, udd_institution_navn, starttrin_kode, sluttrin_kode, noegle, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.udd_institution_type_kode, NEW.ejerstatus_kode, NEW.udd_institution_navn, NEW.starttrin_kode, NEW.sluttrin_kode, NEW.noegle, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5715_botilbud_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5715_botilbud_t (versions_id, botilbud_type_kode, ejerstatus_kode, botilbud_navn, noegle, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.botilbud_type_kode, NEW.ejerstatus_kode, NEW.botilbud_navn, NEW.noegle, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_5716_servicetilbud_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_5716_servicetilbud_t (versions_id, service_type_kode, ejerstatus_kode, servicetilbud_navn, noegle, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.service_type_kode, NEW.ejerstatus_kode, NEW.servicetilbud_navn, NEW.noegle, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6007_inds_omr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6007_inds_omr_t (versions_id, indsatsomr_navn, stoerrelse, ansvar_myndighed, vedtagelse, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.indsatsomr_navn, NEW.stoerrelse, NEW.ansvar_myndighed, NEW.vedtagelse, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6008_maks_bor_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6008_maks_bor_t (versions_id, boredybde, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.boredybde, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6009_indv_ovflv_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6009_indv_ovflv_t (versions_id, indv_maengde_aar, indv_kapacitet, indvinder_navn, indvinder_kontakt, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.indv_maengde_aar, NEW.indv_kapacitet, NEW.indvinder_navn, NEW.indvinder_kontakt, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6101_beskyt_rum_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6101_beskyt_rum_t (versions_id, beskyt_rum_kode, klargjort_kode, pladser, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.beskyt_rum_kode, NEW.klargjort_kode, NEW.pladser, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6103_bered_omr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6103_bered_omr_t (versions_id, bereds_distrikt_nr, bereds_distrikt_navn, udrykker, noegle, gyldig_fra, gyldig_til, link, geometri)
      SELECT
        NEW.versions_id, NEW.bereds_distrikt_nr, NEW.bereds_distrikt_navn, NEW.udrykker, NEW.noegle, NEW.gyldig_fra, NEW.gyldig_til, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6105_sbygn_omr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6105_sbygn_omr_t (versions_id, saer_distrikt_nr, saer_distrikt_navn, navn, kontakt_info, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.saer_distrikt_nr, NEW.saer_distrikt_navn, NEW.navn, NEW.kontakt_info, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6107_forholds_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6107_forholds_t (versions_id, gyldig_fra, gyldig_til, bra_kode, net_tlf, cvr_firma, vejkode, cvf_vejkode, husnr, postnr, adr_i_tekst, tlf_arbejde, tlf_dag, tlf_nat, aba_kode, avs_kode, ars_kode, noegleboks_kode, noeglested, central_placering, opgave_ankomst, prs_1, prs_2, prs_3, prs_4, prs_5, system_fkt, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.gyldig_fra, NEW.gyldig_til, NEW.bra_kode, NEW.net_tlf, NEW.cvr_firma, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.adr_i_tekst, NEW.tlf_arbejde, NEW.tlf_dag, NEW.tlf_nat, NEW.aba_kode, NEW.avs_kode, NEW.ars_kode, NEW.noegleboks_kode, NEW.noeglested, NEW.central_placering, NEW.opgave_ankomst, NEW.prs_1, NEW.prs_2, NEW.prs_3, NEW.prs_4, NEW.prs_5, NEW.system_fkt, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6108_moedepl_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6108_moedepl_t (versions_id, navn, vejkode, cvf_vejkode, husnr, postnr, note, bemaerkning, link_tegn, link, geometri)
      SELECT
        NEW.versions_id, NEW.navn, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.note, NEW.bemaerkning, NEW.link_tegn, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6110_noegle_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6110_noegle_t (versions_id, bra_kode, tyv_alarm_kode, noegleboksnr, vejkode, cvf_vejkode, husnr, postnr, bemaerkning, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.bra_kode, NEW.tyv_alarm_kode, NEW.noegleboksnr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.bemaerkning, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6111_fyrv_till_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6111_fyrv_till_t (versions_id, fyr_firma_navn, fyr_firma_cvr, vejkode, cvf_vejkode, husnr, postnr, tilladelse_type_kode, gyldig_fra, gyldig_til, link, geometri)
      SELECT
        NEW.versions_id, NEW.fyr_firma_navn, NEW.fyr_firma_cvr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.tilladelse_type_kode, NEW.gyldig_fra, NEW.gyldig_til, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6113_besk_nat_b_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6113_besk_nat_b_t (versions_id, noegle, link, geometri)
      SELECT
        NEW.versions_id, NEW.noegle, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6116_olie_ber_pl_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6116_olie_ber_pl_t (versions_id, navn, strand_type_kode, prioritet, esi_klasse_kode, baad_kode, sagsnr, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.navn, NEW.strand_type_kode, NEW.prioritet, NEW.esi_klasse_kode, NEW.baad_kode, NEW.sagsnr, NEW.note, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6117_inds_pkt_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6117_inds_pkt_t (versions_id, nr_navn, beskrivelse, adgang, vej_afstand, ansvar, indsatstype_kode, note, sagsnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.nr_navn, NEW.beskrivelse, NEW.adgang, NEW.vej_afstand, NEW.ansvar, NEW.indsatstype_kode, NEW.note, NEW.sagsnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6118_bran_redn_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6118_bran_redn_t (versions_id, redarea_type_kode, rednarea_underomr, note, bygn_kompleks, byg_sag_nr, vejkode, cvf_vejkode, husnr, postnr, link, geometri)
      SELECT
        NEW.versions_id, NEW.redarea_type_kode, NEW.rednarea_underomr, NEW.note, NEW.bygn_kompleks, NEW.byg_sag_nr, NEW.vejkode, NEW.cvf_vejkode, NEW.husnr, NEW.postnr, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6800_parl_fl_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6800_parl_fl_t (versions_id, vedlhold_f_type_kode, arbejdssted, konto_nr, udfoerer_enterp, kommunal_kontakt, anlaegsaar, etabl_pleje_udloeb, udskiftningaar, udtyndaar, klip_hoejde, klip_sider, klip_flade, driftniv_kode, ukrudtsbek_kode, tilstand_kode, noegle, note, vejkode, link, geometri)
      SELECT
        NEW.versions_id, NEW.vedlhold_f_type_kode, NEW.arbejdssted, NEW.konto_nr, NEW.udfoerer_enterp, NEW.kommunal_kontakt, NEW.anlaegsaar, NEW.etabl_pleje_udloeb, NEW.udskiftningaar, NEW.udtyndaar, NEW.klip_hoejde, NEW.klip_sider, NEW.klip_flade, NEW.driftniv_kode, NEW.ukrudtsbek_kode, NEW.tilstand_kode, NEW.noegle, NEW.note, NEW.vejkode, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6801_parl_li_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6801_parl_li_t (versions_id, vedlhold_l_type_kode, arbejdssted, konto_nr, udfoerer_entrep, kommunal_kontakt, anlaegsaar, etabl_pleje_udloeb, udskiftningaar, klip_flade, klip_hoejde, klip_sider, klip_bredde, driftniv_kode, ukrudtsbek_kode, tilstand_kode, noegle, note, vejkode, link, geometri)
      SELECT
        NEW.versions_id, NEW.vedlhold_l_type_kode, NEW.arbejdssted, NEW.konto_nr, NEW.udfoerer_entrep, NEW.kommunal_kontakt, NEW.anlaegsaar, NEW.etabl_pleje_udloeb, NEW.udskiftningaar, NEW.klip_flade, NEW.klip_hoejde, NEW.klip_sider, NEW.klip_bredde, NEW.driftniv_kode, NEW.ukrudtsbek_kode, NEW.tilstand_kode, NEW.noegle, NEW.note, NEW.vejkode, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6802_parl_pkt_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6802_parl_pkt_t (versions_id, vedlhold_p_type_kode, arbejdssted, konto_nr, udfoerer_enterp, kommunal_kontakt, anlaegsaar, etabl_pleje_udloeb, udskiftningsaar, klip_flade, driftniv_kode, ukrudtsbek_kode, tilstand_kode, noegle, note, vejkode, link, geometri)
      SELECT
        NEW.versions_id, NEW.vedlhold_p_type_kode, NEW.arbejdssted, NEW.konto_nr, NEW.udfoerer_enterp, NEW.kommunal_kontakt, NEW.anlaegsaar, NEW.etabl_pleje_udloeb, NEW.udskiftningsaar, NEW.klip_flade, NEW.driftniv_kode, NEW.ukrudtsbek_kode, NEW.tilstand_kode, NEW.noegle, NEW.note, NEW.vejkode, NEW.link, NEW.geometri;
...
CREATE OR REPLACE FUNCTION fkg.t_6803_parl_omr_trg() RETURNS trigger AS $$
  BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
      ...
      -- Insert into theme
      INSERT INTO fkg.t_6803_parl_omr_t (versions_id, pg_distrikt_kode, pg_distrikt_nr, ansvarlig, udfoerer, udfoerer_kontakt1, udfoerer_kontakt2, kommunal_kontakt, note, link, geometri)
      SELECT
        NEW.versions_id, NEW.pg_distrikt_kode, NEW.pg_distrikt_nr, NEW.ansvarlig, NEW.udfoerer, NEW.udfoerer_kontakt1, NEW.udfoerer_kontakt2, NEW.kommunal_kontakt, NEW.note, NEW.link, NEW.geometri;
