...
-- postnr lookup table created by SQL: select 'INSERT INTO fkg.d_basis_postnr VALUES (' || CAST(postnr AS character varying) || ',''' || postbynavn || ''',1);' FROM adr_mbbl.postnr WHERE COALESCE (btrim(postnr),'')<>'';
